...
[(筆者は読むことができません)]{.light-gray-text}。
これを **機械語** と呼びます。

人間にはとても読みづらく、書きづらいです。
しかし、コンピュータはこの形でしか理解できません。
この問題を解決するために、
[人間にわかりやすい命令方法（言葉）]{.blue-text}
と、
[それを翻訳するプログラム]{.blue-text}
が開発されました。
それが
[プログラミング言語]{.red-dark-10}
と
[コンパイラ]{.red-text}
です。

人間にわかりやすくよう設計された開発プログラミング言語を使って、
[理解しづらいコードを書くことは、矛盾します。]{.red-text}
だからこそ、ソースコードはわかりやすく書くべきです。
プログラミング言語の設計思想に沿って、常によみやさを意識して、誰が見ても理解しやすいようにしましょう。

### 他人によみやすく

ソースコードをよみやすくすることの重要性を解説しましたが、それは[誰にとって]{.blue-text}でしょうか？
...
定量的に測れるものではありません。
したがって、[普遍的な読みやすさというものがあるわけではない]{.red-text}ということを大前提にしてもらいたいです。
